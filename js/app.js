...
/**!
 * vintageJS for canvas (originaly based on vintageJS 1.1.4)
...
var VintageJS = function(canvas, opts, effect) {

  if (false === (canvas instanceof HTMLCanvasElement)) {
    throw 'The element (1st parameter) must be an instance of HTMLCanvasElement';
  }
